<template>
	<view class="zai-box">
		...
		<view class="zai-form">
			...
			<button class="zai-btn" @tap="phone_login">立即登录</button>
			<navigator url="../zaizai-login/index" open-type='navigateBack' hover-class="none" class="zai-label">改用手机密码登录</navigator>
		</view>
	</view>
</template>
