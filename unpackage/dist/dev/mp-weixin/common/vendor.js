...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"MoodRecord","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!********************************************************!*\
  !*** C:/Users/lenovo/Desktop/MoodRecordAPP/pages.json ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!************************************************************!*\
  !*** C:/Users/lenovo/Desktop/MoodRecordAPP/store/index.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ChangeNote: function ChangeNote(state, data) {
      state.note2 = data;
    },
    ChangeNote1: function ChangeNote1(state, data) {
      state.note1 = data;
    },
    ChangeToken: function ChangeToken(state, data) {
      state.token_user_id = data;
    },
    ChangemoodBoom: function ChangemoodBoom(state, data) {
      state.moodBoomList = data;
    },
    ADDmoodBoom: function ADDmoodBoom(state) {
      for (var i = 0; i < state.moodBoomList.length; i++) {
        ...
        if (state.moodBoomList[i].whichExpression == 1) {
          state.moodBoomList[i].whichExpression = 'http://ray34.cn-sh2.ufileos.com/%E4%B8%89%E5%88%9B%E8%B5%9B%2Fexpression%2F1.png';
          state.moodBoomList[i].whichExpressionText = '开心';
        } else
        if (state.moodBoomList[i].whichExpression == 2) {
        ...
        if (state.moodBoomList[i].whichExpression == 3) {
        ...
        if (state.moodBoomList[i].whichExpression == 4) {
        ...
        if (state.moodBoomList[i].whichExpression == 5) {
        ...
        if (state.moodBoomList[i].whichExpression == 6) {
    ...
    ADDdayRemind: function ADDdayRemind(state) {
    ...
    ChangedayRemind: function ChangedayRemind(state, data) {
      state.dayRemindList = data;
    },
    UPDATEdayRemind: function UPDATEdayRemind(state, data) {
      var tmp_str;
      ...
      for (var k = 0; k < state.dayRemindList.length; k++) {
        if (state.dayRemindList[k].dayString == data.dayString) {
          ...
          _vue.default.set(state.dayRemindList, k, data);
          break;
        }
        console.log(state.dayRemindList[k]);
      }
    },
    UNSHIFTdayRemind: function UNSHIFTdayRemind(state, data) {
      var tmp_str;
      tmp_str = data.targetOption.split(' ');
      var total = 0;
      for (var j = 0; j < tmp_str.length; j++) {
    ...
    UNSHIFTmoodBoom: function UNSHIFTmoodBoom(state, data) {
      ...
      if (data.whichExpression == 1) {
        data.whichExpression = 'http://ray34.cn-sh2.ufileos.com/%E4%B8%89%E5%88%9B%E8%B5%9B%2Fexpression%2F1.png';
        data.whichExpressionText = '开心';
      } else
      if (data.whichExpression == 2) {
